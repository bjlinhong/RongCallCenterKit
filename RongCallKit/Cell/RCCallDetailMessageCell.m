...
- (void)setAutoLayout {
    RCSCallSummaryMessage *callMessage = (RCSCallSummaryMessage *)self.model.content;
    ...
    if (callMessage.mediaType == RCSCallMediaTypeVideo && self.messageDirection == MessageDirection_RECEIVE) {
        self.mediaTypeIcon.image = [RCCallKitUtility imageFromVoIPBundle:@"voip/video_left.png"];
    } else if (callMessage.mediaType == RCSCallMediaTypeVideo && self.messageDirection == MessageDirection_SEND) {
        self.mediaTypeIcon.image = [RCCallKitUtility imageFromVoIPBundle:@"voip/video_right.png"];
    } else if (callMessage.mediaType == RCSCallMediaTypeAudio && self.messageDirection == MessageDirection_RECEIVE &&
    ...
    } else if (callMessage.mediaType == RCSCallMediaTypeAudio && self.messageDirection == MessageDirection_SEND &&
               callMessage.duration > 0) {
