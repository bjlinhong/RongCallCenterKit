 ...
 */
@interface RCCallBaseViewController : UIViewController <RCSCallSessionDelegate>
...
/*!
 通话实体
 */
@property (nonatomic, strong, readonly) RCSCallSession *callSession;
 ...
 */
- (void)resetLayout:(BOOL)isMultiCall mediaType:(RCSCallMediaType)mediaType callStatus:(RCSCallStatus)callStatus;
