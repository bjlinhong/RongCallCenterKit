...
- (void)resetLayout:(BOOL)isMultiCall mediaType:(RCSCallMediaType)mediaType callStatus:(RCSCallStatus)sessionCallStatus {
    ...
    if (callStatus == RCSCallStatusIncoming) {
    ...
    } else if (callStatus == RCSCallStatusInviting || (callStatus == RCSCallStatusConnected && !self.isFullScreen)) {
        ...
        self.userCollectionView.showsHorizontalScrollIndicator = NO;
        self.userCollectionView.hidden = NO;
    } else if (callStatus == RCSCallStatusConnected && self.isFullScreen) {
        self.userCollectionView.frame = CGRectMake(
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    if (self.callSession.callStatus == RCSCallStatusConnected && userModel.profile.callStatus == RCSCallStatusConnected) {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.callSession.callStatus == RCSCallStatusConnected) {
        ...
        if (selectedModel.profile.callStatus != RCSCallStatusConnected) {
            return;
        }
